...
public class BlockItem extends Item {
    ...
    public BlockItem(Supplier<? extends Block> blockIn, Properties builder) {
        super(builder);
        this.block = blockIn;
    }
    ...
    public static boolean setTileEntityNBT(World worldIn, @Nullable PlayerEntity player, BlockPos pos, ItemStack stackIn) {
        ...
        if (minecraftServer != null) {
            CompoundNBT compoundNBT2 = stackIn.getChildTag("BlockEntityTag");
            if (compoundNBT2 != null) {
                ...
                if (tileEntity != null) {
                    ...
                    compoundNBT.merge(compoundNBT2);
